...
const VoirPertePage = () => {
  ...
  return (
    ...
    <main className="flex-1 h-screen bg-[#F5F5F5] relative">
      ...
      <div className="w-full flex items-center justify-between mt-14 md:mt-8 px-6 mb-2 py-2">
        <h3 className="text-3xl font-bold text-blue-900">Mes Pertes</h3>
      ...
      <div className="px-1 md:px-6 w-full">
        <div className="w-full h-[100%] bg-white px-4 shadow-2xl rounded-tl-2xl rounded-tr-2xl pt-5">
          <div className="flex items-center justify-between mt-5 relative">
            ...
            {filter && (
              <div className="absolute right-0 w-[160px] top-15 md:top-8 z-10 bg-blue-400 px-2 py-5 rounded-md">
                <div className="mb-4">
            ...
            <table className="w-full border-1 px-4">
              <thead>
                <tr>
                  ...
                  <th className="text-start hidden md:table-cell px-6">Date de perte</th>
                  <th className="text-start hidden md:table-cell px-6">Description</th>
              ...
              <tbody>
                {ventes.map((vt, id) => (
                  ...
                  >
                    ...
                    <td className="text-start hidden md:table-cell px-6">{vt.date_perte}</td>
                    <td className="text-start hidden md:table-cell px-6">{vt.description}</td>
